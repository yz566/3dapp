...
<section class="about-section pt-120 pb-120">
    <div style="color:black;width:max-width:1200px;margin:0 auto;text-align:center;font-size:30px;">
	    <?php echo ($title); ?>
	</div>
	<div style="color:black;width:max-width:1200px;width:1200px;margin:0 auto;font-size:20px;line-height:50px;">
	    <?php echo ($content); ?>
	</div>
</section>
