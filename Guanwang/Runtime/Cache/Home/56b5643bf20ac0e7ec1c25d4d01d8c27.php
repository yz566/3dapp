...
<?php if(is_array($modelist)): $i = 0; $__LIST__ = $modelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$modelist): $mod = ($i % 2 );++$i;?><section class="about-section pt-120 pb-120">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-thumb" style="text-align:center">
                    <img src="/Public/picture/<?php echo ($modelist["img"]); ?>"  style="width:250px;height:300px;" >
                </div>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                <div class="about-content">
                    <h3>
                        <?php echo ($modelist["title"]); ?>
                    </h3>
                    <p>
                        <?php echo ($modelist["content"]); ?>
                    </p>
                    
                    <a href="/index.php/Home/Index/showdetail/id/<?php echo ($modelist["id"]); ?>" class="cmn--btn mt-4">
                        view 3d model
                    </a>
                </div>
            </div>
